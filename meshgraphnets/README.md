# Adapted from the MeshGraphNets model by Google DeepMind by Fei Zhou
New features: 3D graph connectivity, regular rectangular mesh in 2D and 3D microstructure simulations, different activation functions, adaptive mesh refinement.
