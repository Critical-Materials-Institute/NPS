...
gpu_amr=np.load('nvert_time_dim3_device_3-dat3D64-amrAMR2-nrollout3-npred400.npy')[...,:Nsim]
gpu_amr=np.mean(gpu_amr,axis=0,keepdims=True)
gpu_noamr=np.load('nvert_time_dim3_device_3-dat3D64-amrnoAMR-nrollout3-npred400.npy')[...,:Nsim]
